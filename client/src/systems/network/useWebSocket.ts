...
export function useWebSocket() {
  ...
  const { createPlayerChat, addPlayerChatMessage, addGlobalChatMessage } =
    useChatStore();
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      newSocket.off('error');
      newSocket.off('playerChatRoomCreated');
      newSocket.off('playerChatRoomJoined');
      newSocket.off('playerChatMessage');
      newSocket.off('playerChatSystemMessage');
